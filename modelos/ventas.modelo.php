...
class ModeloVentas
{
	...
	MOSTRAR VENTAS
	=============================================*/
	static function mdlMostrarTodasVentas()
	{
	...
	static public function mdlMostrarVentas($tabla, $item, $valor)
	{
		...
		if ($item != null) {
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM ventas WHERE codigo = (SELECT MAX(codigo) FROM ventas)");
	...
	static public function mdlSumaTotalVentas($tabla)
	{
		...
		$stmt = Conexion::conectar()->prepare("SELECT SUM(neto) as total FROM $tabla WHERE estado_corte = 0");
