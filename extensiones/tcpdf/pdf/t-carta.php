        ...
        <tr>
            ...
            <td style="text-align:center;width:25%">
                ...
                <strong>Patron</strong><br>
                    <img src="../../../vistas/img/logo_suc/patron.jpg"  width="70px"/>
                </p>
            ...
            <td style="text-align:center;width:25%">
                ...
                <p>
                <strong>Total:  </strong>$$importe<br>
                </p>
                <p>
                <strong>Anticipo:</strong>$$anticipo<br>
                </p>
                <p>
                ----------------------------<br>
                <strong>Adeudo: $$adeudo</strong><br>
    ...
    <tr>
        <td style="text-align:center;width:100%">
            ...
            <p align="justify" style="font-size:6.9px;" >
                ...
                <br>
                <hr>
                <span align="center">Yo $cliente acepto las políticas de este establecimiento</span>
            </p>
