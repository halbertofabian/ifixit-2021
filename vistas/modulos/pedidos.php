...
if (isset($rutas['1'])) :
  ...
  $pedidos = ModeloPedidos::detallePedido($rutas['1']);
...
?>
    <div class="container">
      <div class="alert alert-danger" role="alert">
        ...
        El pedido con número <?php echo $rutas['1'] ?> no se encuentra. Intente de nuevo <a href="<?php echo $url ?>lista-pedidos">Lista de pedidos</a>
      </div>
    </div>


  <?php else :
    //echo '<pre>', print_r($pedidos), '</pre>';

    $contacto = $pedidos['contacto'];
    //echo $contacto.'<br>';
    $array = array();
      ...
      <form action="#" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-12">
            ...
            <div class="form-group">
              <input type="number" class="form-control" placeholder="Numero de peidido" name="pedido" required="" readonly="" value="<?php echo $pedidos['pedido']; ?>">
            </div>

          </div>
          <div class="col-md-8">
            <label for="">Nombre <span class="text-success">(*)</span></label>
            <input type="text" class="form-control" placeholder="Nombre" name="nombre" required="" value="<?php echo $pedidos['nombre']; ?>" id="nombre">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <input type="text" class="form-control" value="<?php echo $correo ?>" placeholder="Correo" name="email" id="email">
          </div>
          ...
          <div class="col-md-2">
            ...
            <input type="date" class="form-control" required="" name="fecha_pedido" value="<?php echo $pedidos['fecha_pedido']; ?>" id="theDate">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4  col-12">
            ...
            <select name="equipo" id="" class="form-control" required="">
              <option value="<?php echo $pedidos['equipo']; ?>"><?php echo $pedidos['equipo']; ?></option>
          ...
          <div class="col-md-4 col-12">
            ...
            <input type="text" class="form-control" placeholder="Marca" name="marca" value="<?php echo $pedidos['marca']; ?>">
          </div>
          <div class="col-md-4 col-12">
            <br>
            <label for="">Modelo</label>
            <input type="text" class="form-control" placeholder="Modelo" name="modelo" value="<?php echo $pedidos['modelo']; ?>">
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-12">
            ...
            <textarea name="encargo" id="" cols="30" rows="5" class="form-control" required=""><?php echo $pedidos['encargo']; ?></textarea>
          </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control importe" placeholder="$" required="" value="<?php echo $pedidos['importe']; ?>" name="importe">
          </div>
          <div class="col-md-4">
            <label for="">Anticipo</label>
            <input type="text" class="form-control anticipo" placeholder="$" value="<?php echo $pedidos['anticipo']; ?>" readonly required="" name="anticipo">
          </div>
          <div class="col-md-4">
            <label for="">Total</label>
            <input type="text" class="form-control total" placeholder="$" required="" value="<?php echo $pedidos['total']; ?>" name="total">
          </div>
        ...
        <div class="row">
          <div class="col-md-4 float-right mb-5">
            <input type="submit" value="Modificar" class="btn btn-dark btn-block" name="btnModificarPedido">
          </div>
        </div>
        <?php $modificar = new ControladorPedidos();
        $modificar->ctrModificarPedido();
        ?>
