        ...
        <tr>
          ...
          if ($value['estado_equipo'] == "Entregado") {
            ...
            if ($value['estado_equipo'] == "Reparado" || $value['estado_equipo'] == "Entregado") {
              echo '<td> <button class="btn btn-success btnCambiarEstadoOrdenTecnico  btn-sm" data-toggle="modal" data-target="#estadoOrden" estadoEquipo="' . $value['estado_equipo'] . '" idServicio="' . $value['orden'] . '" importe="' . $value['importe'] . '" anticipo="' . $value['anticipo'] . '" nota="' . $value['nota'] . '" > ';
            }
            if ($value['estado_equipo'] == "No quedo") {
              echo '<td> <button class="btn btn-danger  btnCambiarEstadoOrdenTecnico btn-sm" data-toggle="modal" data-target="#estadoOrden" estadoEquipo="' . $value['estado_equipo'] . '" idServicio="' . $value['orden'] . '" importe="' . $value['importe'] . '" anticipo="' . $value['anticipo'] . '" nota="' . $value['nota'] . '" >';
            }
            if ($value['estado_equipo'] == "Reparacion" || $value['estado_equipo'] == "Laboratorio") {
              echo '<td> <button class="btn btn-warning btnCambiarEstadoOrdenTecnico  btn-sm" data-toggle="modal" data-target="#estadoOrden" estadoEquipo="' . $value['estado_equipo'] . '" idServicio="' . $value['orden'] . '" importe="' . $value['importe'] . '" anticipo="' . $value['anticipo'] . '" nota="' . $value['nota'] . '" >';
            } ?>
...
<div class="modal fade" id="estadoOrden" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formEstadoServicioTecnico" method="post">
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
