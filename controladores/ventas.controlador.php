...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			$datos = array("id_vendedor"=>$_SESSION["usuario"],
			...
			if($respuesta == "ok"){
				$mov = array(
					'tipo' => 'VENTA',
					'numero_movimiento' => $_POST["nuevaVenta"],
					'concepto' => $_POST["listaProductos"],
					'monto' => $_POST["totalVenta"],
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			if(isset($_GET["fechaInicial"]) && isset($_GET["fechaFinal"])){
				...
				$ventas = ModeloVentas::mdlMostrarTodasVentas();
			...
			foreach ($ventas as $row => $item){
				...
				$cliente = ControladorClientes::ctrMostrarClientes("usuario", $item["id_cliente"]);
				$vendedor = ControladorUsuarios::ctrMostrarUsuarios("usuario", $item["id_vendedor"]);
